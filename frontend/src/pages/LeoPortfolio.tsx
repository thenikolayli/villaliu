...
const LeoPortfolio = () => {
    const images = import.meta.glob("../assets/leo_gallery_images/*.{jpg, png}", {eager: true})

    onMount(() => document.title = "Villaliu - Leo");

    return (
        <>
            <Sidebar/>
            <section class={"relative w-full h-screen p-4 flex flex-col font-[Big_Shoulders]"}>
                <header class="text-7xl mx-auto w-fit">Leo</header>
